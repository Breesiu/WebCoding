...
var title_format = "$('head').children('title').text()";
var date_format = "$('.infos .item, .time').text()";  //need to be processed
var author_format = "$('.sourcebox .flr').text()";
var content_format = "$('.txtinfos').text()";
