...
var seedURL = 'https://xueqiu.com';  // remove "/"

var seedURL_format = "$('a')";
var keywords_format = " $('meta[name=\"keywords\"]').eq(0).attr(\"content\")";
var title_format = "$('title').text()";
var date_format = "$('.avatar__subtitle').children('a').text()";
var author_format = "$('.avatar__name').children('a').attr(\"data-screenname\")";
...
function newsGet(myURL) { //读取新闻页面
    request(myURL, function(err, res, body) { //读取新闻页面
        ...
        else fetch.title = eval(title_format)?eval(title_format):fetch.keywords; //标题
